...
export default function HomePage() {
  ...
  useSEO({
    ...
    description:
      'Shopping corporativo de Jaguariúna com empresas de serviços, saúde, gastronomia, estética e conveniência em um único endereço.',
  ...
  const dynamicCategoryCards: CategoryCard[] = categories.slice(0, 4).map((category: CompanyCategory, index) => ({
    ...
    companiesLabel: formatCompaniesLabel(category.companies.length),
        ...
        <Container className="relative z-10 grid gap-12 py-24 lg:grid-cols-[minmax(0,1fr)_minmax(0,380px)] lg:items-center">
          <div className="space-y-6 text-white">
            ...
            <p className="text-lg text-white/80">
              Um ambiente completo para empresas, profissionais e visitantes com infraestrutura moderna, segurança, conforto e
          ...
          <div className="rounded-3xl bg-white/90 p-8 text-primary-800 shadow-xl backdrop-blur">
            ...
            <p className="mt-3 text-sm text-[#4f5d55]">
              Salas comerciais, clínicas, laboratórios, escritórios, gastronomia, conveniência, beleza e serviços públicos em um
              só endereço.
            </p>
      ...
      <section id="empresas">
        <Container className="space-y-10">
          <div className="max-w-3xl">
            ...
            <h2 className="section-title">Jaguar Center Plaza é o endereço dos principais serviços da cidade</h2>
            <p className="section-subtitle">
              Mais de 70 empresas dos segmentos corporativo, saúde, estética, gastronomia e conveniência prontas para atender você e
              sua empresa.
            </p>
          </div>
        ...
        <Container className="relative z-10 grid gap-12 lg:grid-cols-2 lg:items-center">
          <div className="space-y-4 text-white">
            ...
            <p className="text-base text-white/80">
              Rooftop com vista panorâmica, áreas modulares para treinamentos, lounges corporativos e suporte especializado em
              produção de eventos.
            </p>
          ...
          <div className="relative overflow-hidden rounded-3xl bg-white/10 p-6 shadow-inner backdrop-blur">
            <div className="space-y-4 rounded-2xl bg-white/90 p-6 text-sm text-primary-700 shadow-lg">
              <h3 className="text-lg font-semibold text-primary-800">Infraestrutura completa</h3>
              <p className="text-[#4f5d55]">
                Estacionamento para convidados, salas de apoio, camarins, wi-fi dedicado, sonorização e equipe de recepção
                bilíngue para seus eventos.
              </p>
            </div>
            <div className="mt-4 space-y-4 rounded-2xl bg-white/90 p-6 text-sm text-primary-700 shadow-lg">
      ...
      <section id="novidades">
        <Container className="space-y-10">
          <div className="max-w-3xl">
            ...
            <h2 className="section-title">Acompanhe o que acontece no Jaguar Center Plaza</h2>
            <p className="section-subtitle">

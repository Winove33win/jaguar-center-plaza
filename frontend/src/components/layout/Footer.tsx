      ...
      <Container className="grid gap-10 py-14 md:grid-cols-4">
        <div className="space-y-4">
          ...
          <p className="text-sm leading-relaxed text-primary-100">
            Um hub completo de serviços, saúde, gastronomia e negócios no coração de Jaguariúna.
          </p>
          <p className="text-sm text-primary-100">
            CNPJ 07.711.519/0001-80
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-primary-100">
            ...
            <li>Estacionamento 24h para condôminos</li>
          </ul>
          <p className="mt-4 text-sm text-primary-100">
            Atendimento administrativo: 9h às 18h
          </p>
        </div>
        ...
        <div className="space-y-3 text-sm text-primary-100">
          ...
          <p>CEP 13820-000</p>
          <a
            href="https://maps.app.goo.gl/N9yjq5mPdkmAs1EVA"
            target="_blank"
            rel="noreferrer"
